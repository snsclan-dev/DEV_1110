...
import { Chat_Preview_Image, Chat_Preview_Video, Chat_Upload, chatMessage, chatSlider } from "components/chat"
import type { Message, Room, User } from "types"

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const CHAT_BOX = memo(({ room, obj, line, user, view, openModal }: { room: Room, obj: Message, line: number, user: User, view: Message[], openModal: (modal: Record<string, any>)=> void }) => { 
...
export const Room_Chat = ({ room, view, monitor }: { room: Room, view: Message[], monitor: string })=>{
    ...
    const clickMessage = ()=>{
        ...
        setInput({ message: '' })
        socket.emit('CHAT_MESSAGE', { message: chatMessage($MESSAGE) })
