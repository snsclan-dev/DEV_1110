...
export const Room_Create = ({ onClose }: { onClose: ()=> void})=>{
    ...
    return(<div>
        ...
        <div className="ta_c mg_h2">
            ...
            <>
                <button className="bt_4 c_blue" onClick={clickModify}>대화방 수정</button><button className="bt_4 c_red" onClick={clickDelete}>대화방 삭제</button>
            </>}
        </div>
    </div>)
}