...
export const useFetch = {
    get: (url: string, data?: any): Promise<any> => createFetch('get', url, data), // eslint-disable-line @typescript-eslint/no-explicit-any
    post: (url: string, data?: any): Promise<any> => createFetch('post', url, data ) // eslint-disable-line @typescript-eslint/no-explicit-any
}